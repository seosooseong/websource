...
<div class="row">
	<div class="col-3">
	<div class="nav flex-column nav-pills" id="myMenu"
		role="tablist" aria-orientation="vertical">
		<a class="nav-link active" id="" data-toggle="pill" href="#insert"
			role="tab" aria-controls="v-pills-home" aria-selected="true">도서 정보 입력</a> 
	...
	<div class="col-9">
		<div class="tab-content" id="v-pills-tabContent">
			...
			<div class="tab-pane fade" id="modify" role="tabpanel"aria-labelledby="v-pills-settings-tab">
				<jsp:include page="view/modify.jsp"/>
			</div>
		</div>
	</div>
</div>
