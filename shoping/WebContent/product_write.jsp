...
<form method="post" action="insert.do">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_name" id="name" placeholder="상품명" >
    </div>
  </div>
  <div class="form-group row">
    <label for="goods_price" class="col-sm-2 col-form-label">판매가</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_price" id="price" placeholder="판매가" >
    </div>
  </div>
  <div class="form-group row">
    <label for="goods_color" class="col-sm-2 col-form-label">색상</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_color" id="color" placeholder="색상" >
    </div>
  </div>
  <div class="form-group row">
    <label for="goods_amount" class="col-sm-2 col-form-label">수량</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_amount" id="amount" placeholder="수량" >
    </div>
  </div>
  <div class="form-group row">
    <label for="goods_size" class="col-sm-2 col-form-label">사이즈</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_size" id="psize" placeholder="사이즈" >
    </div>
  </div>
  <div class="form-group row">
